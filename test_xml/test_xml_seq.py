    ...
    for file in files:
        if file.endswith('.jpg'):
            ...
            if len(img_all)>1:
                ...
                start = time.time()
                '''
                cls_lst_all_res,score_lst_all_res,xmin_lst_all_res,ymin_lst_all_res,xmax_lst_all_res,ymax_lst_all_res=filterBBox(img_all,cls_lst_all,score_lst_all,xmin_lst_all,ymin_lst_all,xmax_lst_all,ymax_lst_all, 1.0,0.7,35)
                end = time.time()
                ...
                xmax_lst_all_res = []
                ymax_lst_all_res = []
                for ii in range(len(static_lst_res)):
                    cls_lst_temp = []
                    score_lst_temp = []
                    xmin_lst_temp = []
                    ymin_lst_temp = []
                    xmax_lst_temp = []
                    ymax_lst_temp = []
                    for jj in range(len(static_lst_res[ii])):
                        if 0==static_lst_res[ii][jj]:
                            cls_lst_temp.append(cls_lst_all[ii][jj])
                            score_lst_temp.append(score_lst_all[ii][jj])
                            xmin_lst_temp.append(xmin_lst_all[ii][jj])
                            ymin_lst_temp.append(ymin_lst_all[ii][jj])
                            xmax_lst_temp.append(xmax_lst_all[ii][jj])
                            ymax_lst_temp.append(ymax_lst_all[ii][jj])
                ...
                for ii in range(len(img_all)): #画检测结果
                    ...
                    cv2.putText(img_temp, str(file) + "_" + str(ii)+"/" + str(len(img_all)) , (30,30), font, 1,(0,0,255),2)
                    img_temp = drawResult(img_temp, cls_lst_all[ii],score_lst_all[ii],xmin_lst_all[ii],ymin_lst_all[ii],xmax_lst_all[ii],ymax_lst_all[ii],color=1)
                    cv2.imwrite(savePath_lst_all[ii], img_temp)
...
if __name__ == '__main__':
    ...
    cfg_path = '/opt/ligang/Detectron/test_xml/model/retinanet_79_129999.yaml' #retinanet_71.yaml' 
    weights_path = '/opt/ligang/Detectron/test_xml/model/model_79_129999.pkl'  #'
    input_imagespath = '/opt/ligang/Detectron/test_xml/test2'
    replot_input_imagespath = '/opt/ligang/Detectron/test_xml/test2' #img_replot
    output_image     = '/opt/ligang/Detectron/test_xml/out222'
    output_xmlpath   = '/opt/ligang/Detectron/test_xml/xml222'
